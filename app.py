...
def load_similarity_rdf():
    ...
    try:
        ...
        g.parse("similarity_data.rdf", format="xml")
...
@st.cache_data
def create_networkx_graph(_rdf_graph, _similarity_graph):
...
def main():
    ...
    if section == "Grafo Interactivo":
        ...
        graph_type = st.radio(
            ...
            ["Grafo Completo", "Grafo de Similarity"],
